Acknowledgment:
Portions of the code in this project were generated with the assistance of ChatGPT by OpenAI (2024). This tool was used to support [specific function or task, e.g., "data processing," "API integration," etc.].
